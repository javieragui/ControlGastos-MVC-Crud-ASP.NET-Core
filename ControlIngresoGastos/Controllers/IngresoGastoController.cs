    ...
    public class IngresoGastoController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? mes, int? anyo )
        {
            ...
            var applicationDbContext = _context.IngresoGastos.Include(i => i.Categoria)
                .Where(i => i.Fecha.Month == mes && i.Fecha.Year == anyo);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ingresoGasto = await _context.IngresoGastos.Include(i => i.Categoria)
        ...
        {
            ViewData["CategoriaId"] = new SelectList(_context.Categorias.Where(c => 
                c.Estado == true), "Id", "Nombre");
            return View();
        }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var ingresoGasto = await _context.IngresoGastos
                .Include(i => i.Categoria).FirstOrDefaultAsync(m => m.Id == id);
            if (ingresoGasto == null)
            {
                return NotFound();
            }
